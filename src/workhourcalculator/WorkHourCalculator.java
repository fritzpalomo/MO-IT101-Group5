...
public class WorkHourCalculator {
    ...
    private static final String CSV_FILE_PATH = "/Users/johnallenalcantara/Downloads/MotorPH Employee Data - Attendance Record.csv";

    public Map<String, Long> computeEmployeeWorkHours(String filePath) {
